...
/*
 * Check Device reference manual and define a struct in order 
 */
...
typedef struct 
{
    __CLK uint32_t CR;              //* Control register                             offset: 0x00
    __CLK uint32_t PLLCFG;          //* PLL configuration register                   offset: 0x04
    __CLK uint32_t CFGR;            //* Clock configure register                     offset: 0x08
    __CLK uint32_t CIR;             //* Clock interrupts register                    offset: 0x0C
    __CLK uint32_t AHB1RSTR;        //* AHB1 bus reset register                      offset: 0x10
    __CLK uint32_t AHB2RSTR;        //* AHB2 bus reset register                      offset: 0x14
    __CLK uint32_t AHB3RSTR;        //* AHB3 bus reset register                      offset: 0x18
    uint32_t Reserved0;             //* Reserved bit                                 offset: 0x1C
    __CLK uint32_t APB1RSTR;        //* APB1 bus reset register                      offset: 0x20
    __CLK uint32_t APB2RSTR;        //* APB2 bus reset register                      offset: 0x24
    uint32_t Reserved1[2];          //* Reserved bit                                 offset: 0x28 - 0x2C
    __CLK uint32_t AHB1ENR;         //* AHB1 bus enable register                     offset: 0x30
    __CLK uint32_t AHB2ENR;         //* AHB2 bus enable register                     offset: 0x34
    __CLK uint32_t AHB3ENR;         //* AHB3 bus enable register                     offset: 0x38
    uint32_t Reserved2;             //* Reserved bit                                 offset: 0x3C
    __CLK uint32_t APB1ENR;         //* APB1 bus enable register                     offset: 0x40
    __CLK uint32_t APB2ENR;         //* APB2 bus enable register                     offset: 0x44
    uint32_t Reserved3[2];          //* Reserved bit                                 offset: 0x48 - 0x4C
    __CLK uint32_t AHB1LPENR;       //* AHB1 bus low power mode register             offset: 0x50
    __CLK uint32_t AHB2LPENR;       //* AHB2 bus low power mode register             offset: 0x54
    __CLK uint32_t AHB3LPENR;       //* AHB3 bus low power mode register             offset: 0x58
    uint32_t Reserved4;             //* Reserved bit                                 offset: 0x5C
    __CLK uint32_t APB1LPENR;       //* APB1 bus low power mode register             offset: 0x60
    __CLK uint32_t APB2LPENR;       //* APB2 bus low power mode register             offset: 0x64
    uint32_t Reserved5[2];          //* Reserved bit                                 offset: 0x68 - 0x6C
    __CLK uint32_t BDCR;            //* Backup domain control register               offset: 0x70
    __CLK uint32_t CSR;             //* Clock control and status register            offset: 0x74
    uint32_t Reserved6[2];          //* Reserved bit                                 offset: 0x78 - 0x7C
    __CLK uint32_t SSCGR;           //* Spread spectrum clock generation register    offset: 0x80
    __CLK uint32_t PLLI2SCFGR;      //* PLLI2S configuration register                offset: 0x84
    __CLK uint32_t PLLSAICFGR;      //* PLL configuration register                   offset: 0x88
    __CLK uint32_t DCKCFGR;         //* Dedicated clock configuration register       offset: 0x8C
    __CLK uint32_t CKGATENR;        //* Clocks gated enable register                 offset: 0x90
    __CLK uint32_t DCKCFGR2;        //* Dedicated clock configuration register 2     offset: 0x94
}RCC_TypeDef_t;
/*
